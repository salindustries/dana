...
class Index extends Component
{
    ...
    public function render()
    {
        ...
        if ($curUser->role_id === Role::ADMIN || $curUser->role_id === Role::AUDITOR) {
            ...
            return view('livewire.collection.index', [
                'users' => User::searchMultipleOrgUsers($this->search)->orderBy($this->sortField, $this->sortDirection)->paginate($this->perPage)
            ]);
        }
    }
}
