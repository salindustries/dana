<nav {{ $attributes->merge(['class' => 'navbar navbar-expand-lg position-absolute top-0 z-index-3']) }}>
  <div
    class="container {{ in_array(request()->route()->getName(), ['illustration-sign-up', 'illustration-sign-in', 'illustration-reset', 'illustration-verification', 'illustration-lock', 'cover-lock', 'cover-sign-up']) ? 'ps-2 pe-0' : '' }}">

    <a class="navbar-brand font-weight-bolder ms-lg-0 ms-3 d-flex flex-column {{ in_array(request()->route()->getName(), ['illustration-sign-up', 'illustration-sign-in', 'illustration-reset', 'illustration-verification', 'illustration-lock']) ? '' : 'text-white' }}"
        ...
        @auth
          <li class="nav-item dropdown dropdown-hover mx-2">
            <a role="button" class="nav-link ps-2 d-flex justify-content-between cursor-pointer align-items-center"
              ...
              Pages
              <img
                src=" {{ asset('assets') }}/img/down-arrow-{{ in_array(request()->route()->getName(), ['illustration-sign-up', 'illustration-sign-in', 'illustration-reset', 'illustration-verification', 'illustration-lock']) ? 'dark' : 'white' }}.svg  "
                alt="down-arrow" class="arrow ms-1 d-lg-block d-none">
            ...
            <div class="dropdown-menu dropdown-menu-animation dropdown-md border-radius-xl p-3 mt-0 mt-lg-3"
                  ...
                  <ul class="list-group">
                    <li class="nav-item dropdown dropdown-hover dropdown-subitem list-group-item border-0 p-0">
                      ...
                      <div class="dropdown-menu mt-0 py-3 px-2" aria-labelledby="dropdownSignIn">
                        <a class="dropdown-item ps-3 border-radius-md mb-1" href="{{ route('basic-sign-in') }}">
                          <span>Basic</span>
                        </a>
                        <a class="dropdown-item ps-3 border-radius-md mb-1" href="{{ route('cover-sign-in') }}">
                          <span>Cover</span>
                        </a>
                        <a class="dropdown-item ps-3 border-radius-md" href="{{ route('illustration-sign-in') }}">
                    ...
                    <li class="nav-item dropdown dropdown-hover dropdown-subitem list-group-item border-0 p-0">
                      ...
                      <div class="dropdown-menu mt-0 py-3 px-2" aria-labelledby="dropdownSignUp">
                        <a class="dropdown-item ps-3 border-radius-md mb-1" href="{{ route('basic-sign-up') }}">
                          <span>Basic</span>
                        </a>
                        <a class="dropdown-item ps-3 border-radius-md mb-1" href="{{ route('cover-sign-up') }}">
                          <span>Cover</span>
                        </a>
                        <a class="dropdown-item ps-3 border-radius-md" href="{{ route('illustration-sign-up') }}">
                          <span>Illustration</span>
                        </a>
                      </div>
                    </li>
                    <li class="nav-item dropdown dropdown-hover dropdown-subitem list-group-item border-0 p-0">
                      ...
                      <div class="dropdown-menu mt-0 py-3 px-2" aria-labelledby="dropdownPasswordReset">
                        <a class="dropdown-item ps-3 border-radius-md mb-1" href="{{ route('basic-reset') }}">
                          <span>Basic</span>
                        </a>
                        <a class="dropdown-item ps-3 border-radius-md mb-1" href="{{ route('cover-reset') }}">
                          <span>Cover</span>
                        </a>
                        <a class="dropdown-item ps-3 border-radius-md" href="{{ route('illustration-reset') }}">
                          <span>Illustration</span>
                        </a>
                      </div>
                    </li>
                    <li class="nav-item dropdown dropdown-hover dropdown-subitem list-group-item border-0 p-0">
                      ...
                      <div class="dropdown-menu mt-0 py-3 px-2" aria-labelledby="dropdownLock">
                        <a class="dropdown-item ps-3 border-radius-md mb-1" href="{{ route('basic-lock') }}">
                          <span>Basic</span>
                        </a>
                        <a class="dropdown-item ps-3 border-radius-md mb-1" href="{{ route('cover-lock') }}">
                          <span>Cover</span>
                        </a>
                        <a class="dropdown-item ps-3 border-radius-md" href="{{ route('illustration-lock') }}">
                          <span>Illustration</span>
                        </a>
                      </div>
                    </li>
                    <li class="nav-item dropdown dropdown-hover dropdown-subitem list-group-item border-0 p-0">
                      ...
                      <div class="dropdown-menu mt-0 py-3 px-2" aria-labelledby="dropdown2fa">
                        <a class="dropdown-item ps-3 border-radius-md mb-1" href="{{ route('basic-verification') }}">
                          <span>Basic</span>
                        </a>
                        <a class="dropdown-item ps-3 border-radius-md mb-1" href="{{ route('cover-verification') }}">
                          <span>Cover</span>
                        </a>
                        <a class="dropdown-item ps-3 border-radius-md" href="{{ route('illustration-verification') }}">
                          <span>Illustration</span>
                        </a>
                      </div>
                    </li>
              ...
              <div class="row d-lg-none">
                <div class="col-12 d-flex justify-content-center flex-column">
                  ...
                  <a href="{{ route('illustration-verification') }}" class="dropdown-item border-radius-md ps-4">
                    Illustration
                  </a>
                  <h6 class="dropdown-header text-dark font-weight-bolder d-flex align-items-center mt-3 px-0">
                    <i class="material-icons opacity-6 me-2 text-md">warning</i>
          ...
          <li class="nav-item dropdown dropdown-hover mx-2">
            <a role="button" class="nav-link ps-2 d-flex justify-content-between cursor-pointer align-items-center"
              ...
              Applications
              <img
                src=" {{ asset('assets') }}/img/down-arrow-{{ in_array(request()->route()->getName(), ['pricing-page', 'basic-lock', 'basic-reset', 'basic-sign-in', 'basic-sign-up', 'basic-verification', 'cover-lock', 'cover-reset', 'cover-sign-in', 'cover-sign-up', 'cover-verification', 'error404', 'error500', 'register', 'login']) ? 'white' : 'dark' }}.svg "
                alt="down-arrow" class="arrow ms-1 d-lg-block d-none">
              <img src="{{ asset('assets') }}/img/down-arrow-dark.svg" alt="down-arrow"
                class="arrow ms-1 d-lg-none d-block">
            </a>
                  ...
                  <li class="nav-item list-group-item border-0 p-0">
                    <a class="dropdown-item border-radius-md text-dark"
                      ...
                      <div class="d-flex align-items-center">
                        ...
                        <h6 class="dropdown-header text-dark font-weight-bolder d-flex align-items-center p-0 mb-0">
                          Getting Started</h6>
                      </div>
