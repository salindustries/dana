<aside
  ...
  <div class="sidenav-header">
    ...
    <a class="navbar-brand m-0 p-4 d-flex align-items-center text-wrap" href="{{ route('analytics') }}">
      ...
      <span class="ms-2 font-weight-bold text-white">INFAQ by TradaX</span>
    </a>
  </div>
        ...
        <div class="collapse {{ strpos(Request::route()->uri(), 'laravel-examples') === false ? '' : 'show' }} "
          ...
          <ul class="nav ">
            ...
            @can('manage-users', App\Models\User::class)
              <li class="nav-item {{ strpos(Request::route()->uri(), 'user-management') === false ? '' : 'active' }}">
              ...
              <li class="nav-item {{ strpos(Request::route()->uri(), 'role-management') === false ? '' : 'active' }} ">
